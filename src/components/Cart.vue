<template>
	<div class="container">
		<h3>Your Cart ({{ shopStore.goodsInCart.length }})</h3>
		<div v-if="shopStore.goodsInCart.length === 0" class="cart-empty">
			<div class="image">
				<svg xmlns="http://www.w3.org/2000/svg" width="128" height="128" fill="none" viewBox="0 0 128 128">
					...
					<path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth=".974"
		...
		<div v-else class="cart-not-empty">
			...
			<CartItem
				v-for="good in shopStore.goodsInCart"
				:key="good.id"
				:good="good" />

			<div class="total-order">
				<span class="text">Order Total</span>
				<span class="total-price">{{ shopStore.totalPrice }}</span>
			</div>
...
const showPopup = () => {
	shopStore.isShowPopup = !shopStore.isShowPopup
